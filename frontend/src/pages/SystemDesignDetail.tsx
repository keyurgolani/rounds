...
function StatusBar({ questionId }: { questionId: number }) {
  // Stable numeric key so list/dashboard `effectiveStatus('system', id)` and
  // detail page state both share the same localStorage entry.
  const [status, setStatus] = usePracticeStatus('system', questionId, 'todo');
