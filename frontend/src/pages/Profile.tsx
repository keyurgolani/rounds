  ...
  return (
    <div className="h-full overflow-y-auto">
      <PageHeader
        ...
        title="Your profile"
        subtitle="How you show up inside Rounds — the name at the top of the sidebar, the target role you're prepping for, and a line of context for future you."
      />

      <div className="mx-auto px-8 py-6 grid gap-6" style={{ maxWidth: 920, gridTemplateColumns: 'minmax(0, 1fr) 300px' }}>
