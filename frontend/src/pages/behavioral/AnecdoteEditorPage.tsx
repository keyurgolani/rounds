  ...
  return (
    <div className="h-full overflow-y-auto">
      <PageHeader
        ...
        subtitle="Capture the story once. Pull it back up whenever an interviewer prompts for it."
      />

      <form onSubmit={handleSave} className="mx-auto px-8 py-6" style={{ maxWidth: 820 }}>
