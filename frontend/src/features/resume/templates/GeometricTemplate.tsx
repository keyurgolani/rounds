// Creative — geometric. A diagonal accent wedge in the upper-left
// corner anchors the page; everything else is clean sans-serif. The
// wedge is pure CSS (no images), so it scales with zoom and prints
// fine. Section heads carry a small accent square as a marker.
...
export default function GeometricTemplate({ data, design }: Props) {
  const accent = design?.colors?.primary ?? '#e35d3a';
  const fontFamily =
