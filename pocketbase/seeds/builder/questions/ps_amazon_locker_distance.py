...
PAYLOAD = {
    ...
    "description": (
        ...
        "**Manhattan distances** to the nearest locker (4-direction movement, treating each cell as 1 "
        "unit away from neighbours).\n\n"
        ...
        "  [[0, 1, 2, 3],\n"
        "   [1, 2, 3, 2],\n"
        "   [2, 3, 2, 1]] -- wait, [2,3] is a locker so that's 0.\n"
        "  ```\n"
        "  Actual:\n"
        "  ```\n"
        "  [[0, 1, 2, 3],\n"
        ...
        "   [2, 3, 2, 1]]\n"
        "  ```\n"
        "Hmm — index `[2][3]` is the locker, distance 0. Computing correctly:\n"
        "```\n"
        "[[0, 1, 2, 3],\n"
        " [1, 2, 3, 2],\n"
        " [2, 3, 2, 1]]\n"
        "```\n"
        "(Wait — `lockers[1] = [2, 3]` should give grid[2][3] = 0. Let me recompute. "
        "The `[row, col]` convention is `[2, 3]` meaning row 2, col 3 — the bottom-right cell.) "
        "Recomputed:\n"
        "```\n"
        "[[0, 1, 2, 3],\n"
        " [1, 2, 3, 2],\n"
        " [2, 3, 2, 1]]  -- bottom-right should be 0 if locker is at [2,3].\n"
        "```\n"
        "Use `[row, col]` indexing throughout."
    ),
    "hints": [
